...
**English** | [中文](https://github.com/huturen/http-request-mock/blob/main/README.MD)
...
It'll return and do a real request use original request object if no request is matched.
...
* **Unit test capability**: It can be used in a `jest`, `mocha` and `ava` enviroment,.
